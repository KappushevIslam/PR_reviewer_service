...
class PullRequest(Base):
    ...
    reviewer_assignments = relationship("ReviewerAssignment", back_populates="pull_request", cascade="all, delete-orphan")
...
class ReviewerAssignment(Base):
    ...
    pull_request_id = Column(String, ForeignKey("pull_requests.pull_request_id", ondelete="CASCADE"), nullable=False, index=True)
